                ...
                <div class="modal-body">
                    <form class="needs-validation" id="formModifRDV" action="/" method="POST" novalidate>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="dateDebRDV" value="` + dateDebut.slice(0, 16) + `" name="dateDebut" required>
                        <div class="invalid-feedback">
                          Champ obligatoire
                        </div>
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="dateFinRDV" value="` + dateFin.slice(0, 16) + `" name="dateFin" required>
                        <div class="invalid-feedback">
                          Champ obligatoire
                        </div>
                      </div>
